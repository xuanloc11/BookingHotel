...
import DestinationDetailsInner from "@/components/destination/DestinationDetailsInner";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    title:
      "Destination Details | EliteStay - Hotel Booking Multi-Purpose Next Js Template",
    description:
    ...
    openGraph: {
      title: "Destination Details | EliteStay",
      description:
        "EliteStay is a professional Next JS Template for Hotel Booking Multi-Purpose services. Clean design, responsive layout, and modern UI components included.",

...
Object.keys(icons).forEach(function (key) {
    if (key === "Editor") {
        iconData = iconData + '<div class="card"><div class="card-body"><h4 class="card-title">' + key + ' </h4><p class="card-title-desc mb-2">Use <code>&lt;i class="ri-bold"&gt;&lt;/i&gt;</code></p><div class="row icons-list-demo">';
        Object.keys(icons[key]).forEach(function (k) {
            iconData += '<div class="col-xl-3 col-lg-4 col-sm-6">\
                    <i class="ri-'+ k + '"></i> ri-' + k + '</div>';
        });
    } else {
        iconData = iconData + '<div class="card"><div class="card-body"><h4 class="card-title">' + key + ' </h4><p class="card-title-desc mb-2">Use <code>&lt;i class="ri-home-line"&gt;&lt;/i&gt;</code> or <code>&lt;i class="ri-home-fill"&gt;&lt;/i&gt;</code></p><div class="row icons-list-demo">';
        Object.keys(icons[key]).forEach(function (k) {
            iconData += '<div class="col-xl-3 col-lg-4 col-sm-6">\

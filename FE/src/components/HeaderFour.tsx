...
const HeaderFour: FC = () => {
  ...
  return (
    <>
      ...
      ></div>
      <div className='header-top-three header-top-four border-0 d-none d-md-block'>
          ...
          <div className='header-top-three-wrapper d-flex justify-content-between'>
            <div className='d-flex tw-gap-10 align-items-center'>
              <div className='d-flex align-items-end tw-gap-1'>
                <span className='text-heading d-inline-block lh-1 tw-text-lg'>
                  <i className='ph ph-envelope' />
                </span>
                <Link
                  className='text-heading font-heading tw-text-315 fw-normal'
            ...
            <div>
              <div className='d-flex align-items-end tw-gap-1'>
                ...
                <p className='text-heading mb-0 font-heading tw-text-315 fw-normal'>
      ...
      <header
        className={`header header-four tw-transition-all tw-z-99 ${
          scroll ? "fixed-header" : ""
        }`}
      >
        <div className='container tw-container-1680-px'>
          <nav
            className='header-four-nav d-flex align-items-center justify-content-between position-relative tw-rounded-xl tw-px-12'
          ...
          >
            ...
            <div className='header-menu d-lg-block d-none'>
              ...
              <ul className='nav-menu d-lg-flex align-items-center tw-gap-8'>
                {desktopMenuData.map((item, index) => {
                  ...
                  if (item.type === "link") {
                    return (
                      <li key={index} className='nav-menu__item text-heading'>
                        <Link
                          href={item.link || "#"}
                          className='nav-menu__link tw-pe-5 text-heading font-heading tw-py-11 fw-normal w-100'
                        >
                          {item.label}
                        </Link>
                      </li>
            ...
            <div className='header-right d-flex'>
              <div className='header-call header-four-call d-flex align-items-center tw-gap-5 tw-me-6'>
                <div>
                  <span>
                    <Image
                      width={24}
                      height={24}
                      src='/assets/images/icons/header-four-phone.svg'
                      alt='cellphone'
                    />
                  </span>
                </div>
                <div>
                  <h6 className='text-heading fw-medium tw-text-sm font-body tw-mb-2'>
                    Need any Help! call Us today
                  </h6>
                  <Link
                    className='text-heading font-heading hover-text-main-600'
              ...
              <button
                ...
                type='button'
                className='toggle-mobileMenu leading-none d-lg-none text-heading tw-text-9'
              >

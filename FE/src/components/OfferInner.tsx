...
const OfferInner: FC = () => {
  return (
    <section className='experience-area pt-120 pb-120 bg_2'>
      <div className='container'>
        ...
        <div className='row'>
          ...
          <div className='col-xl-4 col-lg-6 col-md-6'>
            <div className='experience-wrapper tw-mb-7'>
              <div
                className='experience-thumb position-relative z-1 tw_fade_anim'
                data-delay='.3'
              >
                <Link href='/destination-details'>
                  <Image

...
const AdvanceAreaTwo: FC = () => {
  return (
    <div className='advance-two-area pb-120 position-relative z-1'>
      <div className='container'>
        <div className='row justify-content-between align-items-center tw-mb-25'>
          <div className='col-xl-8 col-lg-8'>
            <div className='section-two-wrapper tw_fade_anim' data-delay='.3'>
              <h6 className='section-two-subtitle tw-text-xl text-uppercase text-white tw-mb-6'>
                Discover Beauty Through Our Lens
              </h6>
              <h2 className='section-two-title text-white tw-text-16 fw-normal tw-char-animation'>
